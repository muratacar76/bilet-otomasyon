        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArrivalCity = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityNumber = table.Column<string>(type: "TEXT", maxLength: 11, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatType = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    IsOccupied = table.Column<bool>(type: "INTEGER", nullable: false),
                    Row = table.Column<int>(type: "INTEGER", nullable: false),
                    Column = table.Column<string>(type: "TEXT", maxLength: 1, nullable: false),
                    IsExitRow = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_DepartureCity_ArrivalCity",
                table: "Flights",
                columns: new[] { "DepartureCity", "ArrivalCity" });
